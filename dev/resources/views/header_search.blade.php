            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12 content-area left-side-bar-on">
                    <div class="content-area-desc">
                        ...
                        <!-----------------------------------------------SEARCH END------------------------------------------->
                        <div><br>
                            {!! Form::model($search_key, array('url' => array('searchs'), 'method' => 'get','class' => 'form-horizontal','id'=>'myForm')) !!}
                            <div><b>What are you searching for?</b></div>
                            <div class="form-group m-b-10">
                                <div class="row">
                                    <div class="col-md-5 col-sm-7 col-xs-12 mob-inline-1" style="margin-left:15px;">
                                        {!! Form::text('search_for', $search_key, array('class' => 'form-control','id' => 'search_for')) !!}
                                    </div>
