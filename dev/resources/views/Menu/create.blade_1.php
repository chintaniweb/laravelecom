            ...
            <div class="row">
                <div class="col-lg-12 col-xs-12 p-t-10">
                    <div class="info-title page-info page-info-title">Maintain Daily Defaults (Lunch) | 
                        ...
                        <a href="<?php echo url('/'); ?>Menu_intro/weekend_setting_update/">WEEKEND OPTION</a> | 
                        <a href="<?php echo url('/'); ?>Menu/menuCopy/">COPY MENU</a> | 
                        <a href="<?php echo url('/'); ?>Menu_intro/ical_setting_update/">ICAL OPTION (OFF)</a>
                    </div>
                </div>
                <div class="col-lg-12 col-xs-12 p-0 m-b-10">
                    ...
                    if (isset($day) && $day != "") {
                        ...
                        <!--<form id="myForm2" class="form-horizontal" action="<?php //echo base_url() . 'Menu/Admin/Menu/' . $action . '/' . $this->uri->segment(4);   ?>" method="post">-->
                        ...
                        <div class="form-group">
                            <div class="col-md-10" align="left">
                                ...
                                for ($i = 1; $i <= $day; $i++) {
                                    ...
                                    <textarea style="height:160px" row="100" cols="80" id="menu_<?php echo $i; ?>" name="menu_<?php echo $i; ?>"></textarea>
                                    <textarea style="height:160px" row="100" cols="80" id="other_menu_<?php echo $i; ?>" name="other_menu_<?php echo $i; ?>"></textarea><br/>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-xs-12 pro-action-select text-center m-t-10"> 
                            {!! Form::submit('Save',array('class' => 'form-control','onclick' => 'myFunction()')) !!}</div>
