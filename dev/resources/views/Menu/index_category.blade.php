...
<script type="text/javascript">
           ...
           $(document).ready(function () {           
            var url = BASE_URL + "menu_category/getMenuCategoryList";
            var theme = 'classic';
            var ordersSource =
            {
                 dataFields: [
...
//                        
                ...
                updateRow: function (rowID, rowData, commit) {
                      var data = "update=true&" + $.param(rowData);
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "menu_category/edit/" + rowID,
                            data: data,
                            cache: false,
                            success: function (data, status, xhr) {
                                // insert command is executed.
                ...
                deleteRow: function (rowID, commit) {
                     ...
                     var data = "delete=true&category_id=" + rowID;
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "menu_category/delete/" + rowID,
                            data: data,
                            cache: false,
                            success: function (data, status, xhr) {
                                // insert command is executed.
            ...
            $("#table").jqxDataTable(
            {
                ...
                sortable: true,
                 columns: [
                  { text: 'ID', editable: false, dataField: 'category_id', cellsAlign: 'center', align:'center', width: '5%' },
                  { text: 'Name', dataField: 'category_name', width: '85%'},
                  { text: 'Sort', dataField: 'category_sort', width: '10%'}
