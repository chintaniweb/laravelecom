...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-5">
            <h4 class="page-title">Add Website</h4>
        </div>
    </div>
    <div class="row">
        {!! Form::open(array('url' => 'Website','files'=>'true','id' => 'myForm','class' => 'form-horizontal')) !!}
            ...
            <div class="card-box m-b-0">
                <div class="row">
                    <div class=" col-sm-12 col-xs-12 p-t-b-10">
                        ...
                        <div class="form-group row form-main-box">
                            {!!Form::label('Description','Description',['class'=>'control-label col-sm-4 text-right','style'=>'padding-top:8px'])!!}
                            <div class="col-sm-7">
                        ...
                        <div class="form-group row form-main-box">
                            ...
                            <div class="col-md-7">
                                {!! Form::select('status', ['Yes' => 'Yes','No' => 'No'] ,'Yes',['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        <div class="form-group row form-main-box">
