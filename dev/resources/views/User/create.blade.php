...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 m-t-20">
            ...
            @endif
            {!! Form::open(['action' => 'User@store','autocomplete' => 'off','class'=>'form-horizontal']) !!}      
                    ...
                    <div class=" col-sm-12 col-xs-12 p-t-b-10">
                        ...
                        <div class="form-group row form-main-box boces-role">
                            ...
                            <div class="col-md-7">
                               <select name="boces_role_id" class="form-control">
                                            ...
                                            @foreach ($user_role_boces as $k => $v)
                        ...
                        <div class="form-group row form-main-box eta-role">
                            {!! Form::label('id','Role For ETA',array('class' => 'control-label col-md-4')) !!}
                             <div class="col-md-7">
                                 <select name="eta_role_id" class="form-control">
                                    <option value="">----Select Role-----</option>
                                        @foreach ($user_role_eta as $k => $v)
                                                     <option value="{{$k}}">{{$v}}</option>                                          
                                             @endforeach
                                 </select>
                             </div>
