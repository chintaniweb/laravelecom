            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12 content-area left-side-bar-on">
                    <div class="content-area-desc">
                        ...
                        <p class="alert {{ Session::get('alert-class', 'alert alert-danger') }}">{{ Session::get('message') }}</p>
                        @endif
                        ...
                        if (count($calendar_result) != 0) {
                            echo "<br>";
                            $i = 1;
                            echo "<strong>" . 'Calendar Event' . '</strong><br><br>';
                            foreach ($calendar_result as $row) {
                                echo $i . ". ";
                                ?>
                                <?php
                                if (isset($row->calendar_event_id)) {
                        ...
                        <!---------------------------------------SEARCH END-------------------------->
                        <div><br>
                            {!! Form::open(array('url' => 'searchs','class' => 'form-horizontal','id'=>'myForm','method'=>'get')) !!}
