...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-5">
            <h4 class="page-title"><?php echo "Filing Cabinet Information"; ?></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-12 m-t-20">
            {!! Form::model($data,array('route' => array('Filing_cabinet_intro.update',$data->filing_cabinet_intro_id), 'method' => 'PUT','files'=>'true','class' => 'form-horizontal','id'=>'myForm')) !!}
                    ...
                    <div class=" col-sm-12 col-xs-12 p-t-b-10">
                        ...
                        <div class="form-group row form-main-box">
                            ...
                            <?php if (isset($header_image) && ($header_image != "")) { ?>
                                <a target="_blank" href="<?php echo url('/') . "/resources/views/Filing_cabinet/Filing_cabinet_intro_files/" . $header_image; ?>">View</a>
                                <a href="<?php echo url('/') . "/Filing_cabinet_intro/deleteImage/" . $data->filing_cabinet_intro_id; ?>" onclick="return confirm('Are you sure you want to delete this image?');">|Delete</a>
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4"><strong>Filing Cabinet Intro</strong></label>
