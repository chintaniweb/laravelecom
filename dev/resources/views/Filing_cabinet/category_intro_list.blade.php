...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <h4 class="page-title">Filing Cabinet Category Paragraphs on Pages</h4>
        </div>
    </div>
    <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var orderdetailsurl = BASE_URL + "getFilingCabinetCategoryIntroList";
        var theme = 'classic';

        var ordersSource =
                {
                    dataFields: [
                        {name: 'filing_cabinet_category_intro_id', type: 'int'},
                        {name: 'headline', type: 'String'},
                        {name: 'filing_cabinet_category_intro_id_tmp', type: 'int'}

                    ],
                    root: "data",
                    dataType: "json",
                    cache: false,
                    id: 'filing_cabinet_category_intro_id',
                    url: orderdetailsurl,
                    ...
                    updateRow: function(rowID, rowData, commit) {
                        ...
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "Filing_cabinet/Admin/Filing_cabinet_category_intro/sortUpdate/",
                            data: data,
                            cache: false,
        ...
        $("#dataTable").jqxDataTable(
                {
                    ...
                    pagerButtonsCount: 8,
                    columns: [
                        {text: 'ID', editable: false, dataField: 'filing_cabinet_category_intro_id', width: '5%'},
                        ...
                        {text: 'Action', dataField: 'filing_cabinet_category_intro_id_tmp', cellsAlign: 'center', align: "center", columnType: 'int', width: '15%', minwidth: '80', editable: false, filterable: false, cellsRenderer: function(row, column, value) {

                                actionLink = '<div class="text-center action-icons"><a title="Update Record" href="' + BASE_URL + 'Filing_cabinet_category_intro/' + value + '/edit" class="on-default edit-row text-default"><i class="fa fa-pencil"></i></a></div>'
                                return actionLink;
                            }
                        }
                    ]
