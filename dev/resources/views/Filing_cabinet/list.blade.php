...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <h4 class="page-title">Current Files - On Site</h4>
        </div>
    </div>
                    ...
                    <div role="grid" class="dataTables_wrapper site-content-grid" id="datatable-editable_wrapper">
                        <div class="col-lg-12 p-0">
                            ...
                            <div class="text-right m-b-10">
                                <a class="btn btn-primary" href="<?php echo url('/'); ?>/Filing_cabinet_category">View Category</a>
                                <a class="btn btn-primary" href="<?php echo url('/'); ?>/Filing_cabinet/create">Add Page</a></div> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var orderdetailsurl = BASE_URL + "getFileList/" + id;
        var theme = 'classic';

        var ordersSource =
                {
                    dataFields: [
                        {name: 'filing_cabinet_id', type: 'int'},
                        {name: 'file_name', type: 'string'},
                        {name: 'file_sort', type: 'string'},
                        {name: 'filing_cabinet_id_tmp', type: 'int'}
                    ],
                    sortcolumn: 'file_sort',
                    sortdirection: 'asc',
                    root: "data",
                    dataType: "json",
                    cache: false,
                    id: 'filing_cabinet_id',
                    url: orderdetailsurl,
        ...
        $("#dataTable").jqxDataTable(
                {
                    ...
                    pagerButtonsCount: 8,
                    columns: [
                        {text: 'ID', editable: false, dataField: 'filing_cabinet_id', width: '5%'},
                        {text: 'Name', editable: false, dataField: 'file_name', cellsAlign: 'left', align: 'left', width: '80%'},
                        {text: 'Sort', editable: true, dataField: 'file_sort', cellsAlign: 'center', align: 'center', width: '5%'},
                        {text: 'Action', dataField: 'filing_cabinet_id_tmp', cellsAlign: 'center', align: "center", columnType: 'int', width: '10%', minwidth: '80', editable: false, filterable: false, cellsRenderer: function(row, column, value) {

                                actionLink = '<div class="text-center action-icons"><a title="Update Record" href="' + BASE_URL + 'Filing_cabinet/' + value + '/edit" class="on-default edit-row text-default"><i class="fa fa-pencil"></i></a></div>'
                                return actionLink;
                            }
