...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-5">
            <h4 class="page-title"> <?php echo "Add Quick links"; ?></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-12 m-t-20">
            {!! Form::open(['url'=>'quicklinks/add','class'=>'form-horizontal','id'=>'myForm']) !!} 
                ...
                <div class="row">
                    <div class=" col-sm-12 col-xs-12 p-t-b-10">
                        <div class="form-group row form-main-box">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('link_url',null,['class'=>'form-control', 'id' => 'link_url']) !!}
                            </div>
                        ...
                        <div class="form-group row form-main-box">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('link_friendly',null,['class'=>'form-control', 'id' => 'link_friendly']) !!}
                            </div>
                        ...
                        <div class="form-group row form-main-box">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('link_sort',null,['class'=>'form-control', 'id' => 'link_sort','style'=>'width:100px']) !!}
                            </div>
                        </div>
                        <div class="form-group row form-main-box">
                        ...
                        <div class="form-group row form-main-box">
                            ...
                            <div class="col-md-7">
                                {!! Form::select('link_type',['Public'=>'Public','Internal'=>'Internal'],null,['class'=>'form-control', 'id' => 'link_type']) !!}
                            </div>
                        </div> 
                    </div>
