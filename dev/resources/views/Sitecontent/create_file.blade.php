...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 m-t-20">
            ...
            {!! Form::open(array('url' => url('/').'/sitecontent/add_file/'.$id,'class' => 'form-horizontal','files'=>'true')) !!}
            {!! Form::hidden('_token', csrf_token(), array('class' => 'form-control')) !!}


            <div class="card-box m-b-0">
                <br>
                <div class="info-title page-info page-info-title"> Add New Files </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('friendly_name', null,array('class' => 'form-control','id' => 'friendly_name')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {!! Form::textarea('file_description', null,array('class' => 'form-control','id' => 'file_description')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!!Form::label('Sort','Sort',['class' => 'control-label col-md-4'])!!}
                            <div class="col-md-7">
                                {!! Form::text('file_sort', null,array('class' => 'form-control','id' => 'file_sort')) !!}
                            </div>
                        </div>
                    </div>
