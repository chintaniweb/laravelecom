...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var url = BASE_URL + "user_permission/getPermissionList";
        var theme = 'classic';
        var ordersSource =
                {
                    dataFields: [
...
//                        $.ajax({
//                            dataType: 'json',
//                            url: BASE_URL + "user_permission/add",
//                            data: data,
//                            cache: false,
...
//                        // you can pass additional argument to the commit callback which represents the new ID if it is generated from a DB.
                    ...
                    updateRow: function (rowID, rowData, commit) {
                        ...
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "user_permission/edit/" + rowID,
                            data: data,
                            cache: false,
                            success: function (data, status, xhr) {
                                // insert command is executed.
                    ...
                    deleteRow: function (rowID, commit) {
                        ...
                        var data = "delete=true&job_category_id=" + rowID;
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "user_permission/delete/" + rowID,
                            data: data,
                            cache: false,
                            success: function (data, status, xhr) {
                                // insert command is executed.
        ...
        $("#table").jqxDataTable(
                {
                    ...
                    columns: [
                        ...
                        {text: 'Display Name', dataField: 'display_name', width: '30%'},
                        {text: 'Description', dataField: 'description', width: '30%'},
                        {text: 'Website ID', editable: true, dataField: 'website_id', cellsAlign: 'center', align: 'center', width: '10%'}
            ]
                });
