...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <h4 class="page-title">URL Redirect List</h4>
        </div>
    </div>
                ...
                <div class="row m-0">
                    <div role="grid" class="dataTables_wrapper site-content-grid" id="datatable-editable_wrapper">
                        <div class="col-lg-12 p-0">
                            ...
                            <div class="text-right m-b-10"> <a class="btn btn-primary" href="<?php echo url('/'); ?>/Redirect_url/create">Add Page</a></div>
...
$(document).ready(function () {
    var orderdetailsurl = BASE_URL + "getRedirectList";
    var theme = 'classic';
    ...
    var ordersSource =
            {
                ...
                updateRow: function (rowID, rowData, commit) {
                    ...
                    $.ajax({
                        dataType: 'json',
                        url: BASE_URL + "Redirect/Admin/Redirect/sortUpdate/",
                        data: data,
                        cache: false,
    ...
    $("#dataTable").jqxDataTable(
            {
                ...
                pagerButtonsCount: 8,
                columns: [
                    {text: 'ID', editable: false, dataField: 'redirect_id', cellsAlign: 'center', align: 'center', width: '5%'},
                    {text: 'Source URL', editable: false, dataField: 'source_url', cellsAlign: 'left', align: 'left', width: '50%'},
                    {text: 'Target URL', editable: false, dataField: 'target_url', cellsAlign: 'left', align: 'left', width: '30%'},
                    ...
                    {text: 'Action', dataField: 'redirect_id_tmp', cellsAlign: 'center', align: "center", columnType: 'int', width: '15%', minwidth: '80', editable: false, filterable: false, cellsRenderer: function (row, column, value) {

                            actionLink = '<div class="text-center action-icons"><a title="Update Record" href="' + BASE_URL + 'Redirect_url/' + value + '/edit" class="on-default edit-row text-default"><i class="fa fa-pencil"></i></a></div>'
                            return actionLink;
                        }
