...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-5">
            <h4 class="page-title">Update URL Redirects</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-12 m-t-20">
            {!! Form::model($data, array('route' => array('Redirect_url.update', $data->redirect_id), 'method' => 'PUT','files'=>'true','class' => 'form-horizontal','id'=>'myForm')) !!}
            ...
            <div class="card-box m-b-0">
                <div class="row">
                    ...
                    <div class="clearfix">
                        <!-- Delete Form --> 
                        {!! Form::open(array('url' => 'Redirect_url/' . $data->redirect_id)) !!}
