                ...
                <div class="card-box m-b-0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                               {!! Form::text('description',$data[0]->description,['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="info-title page-info page-info-title"><strong>Adminstrator Roles Right</strong></div>
                            ...
                            foreach ($permissions_data as $row) {
                                ...
                                <div class="control-group">
                                    <div class="col-sm-3 col-sm-offset-2">
                                        <div class="col-xs-15">
                                            <input type="checkbox" class="m-r-10" name="permissions_id[]" value="<?php echo $row->id; ?>">
