                    ...
                    $("#dataTable").jqxDataTable(
                            {
                                ...
                                columns: [
                                    ...
                                    {text: 'Action', dataField: 'permission_id_tmp', cellsAlign: 'center', align: "center", columnType: 'int', width: '25%', minwidth: '80', editable: false, filterable: false, cellsRenderer: function (row, column, value) {
