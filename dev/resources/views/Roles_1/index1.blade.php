...
<script type="text/javascript">
           ...
           $(document).ready(function () {           
            var url = BASE_URL + "Roles/getRollList";
            var theme = 'classic';
            var ordersSource =
            {
                dataFields: [
...
//                        
                ...
                deleteRow: function (rowID, commit) {
                     ...
                     var data = "delete=true&id=" + rowID;
                        $.ajax({
                            dataType: 'json',
                            url: BASE_URL + "Roles/delete/" + rowID,
                            data: data,
                            cache: false,
                            success: function (data, status, xhr) {
                                // insert command is executed.
            ...
            $("#table").jqxDataTable(
            {
                ...
                sortable: true,
                columns: [
                  { text: 'ID', editable: false, dataField: 'id', cellsAlign: 'center', align:'center', width: '10%' },
                  { text: 'Name', dataField: 'name', width: '20%'},
                  { text: 'Display Name', dataField: 'display_name', width: '35%',cellsAlign: 'center', align:'center'},
