        ...
        <div class="col-xs-12 col-sm-12 m-t-20">
            <div class="card-box m-b-0">
                <div class="row">
                    ...
                    {!! Form::open(array('url' => 'Slide_show/'.$data->slide_show_id.'/edit','class' => 'form-horizontal','id'=>'myFormImage','files'=>'true')) !!}
                    <div class="card-box m-b-0">
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group row form-main-box">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::file('image[]',['class' => 'btn btn-block btn-grey', 'autocomplete' => 'off','multiple'=>'true']),null!!}
                                ...
                                <div class="form-group row form-main-box">
                                    ...
                                    <div class="col-sm-7">
                                        {!!Form::text('image_sort',null,['class'=>'form-control','id'=>'image_sort'])!!}
                                    </div>
                                </div>                        
                                <div class="form-group row form-main-box">
                                    {!!Form::label('Image Caption','Image Caption',['class'=>'control-label col-sm-4','style'=>'padding-top:8px'])!!}
                                    <div class="col-sm-7">
                                        {!!Form::text('image_caption',null,['class'=>'form-control','id'=>'title'])!!}
                                    </div>
                                </div>                        
                            </div>
                            <div class="col-sm-12 col-md-12 col-xs-12 pro-action-select text-center m-t-10">
