        ...
        <div class="col-xs-12 col-sm-12 m-t-20">
            ...
            <div class="tab-main-bg">
                <ul>
                    ...
                    <li class="active"><a href="<?php echo url('/') .'/Form_question/'.$id; ?>" title="">Edit</a></li>
            ...
            {!! Form::model($form_questions, array('route' => array('Form_question.update', $form_questions->form_questions_id), 'method' => 'PUT','files'=>'true','class' => 'form-horizontal','id'=>'myForm')) !!}
                    ...
                    <div class="row">
                        <div class=" col-sm-12 col-xs-12 p-t-b-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    {!! Form::select('question_require', ['Yes' => 'Yes','No' => 'No'],$form_questions->question_require,array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                     {!! Form::select('answer_type', ['ShortAnswer'         => 'Short Answer',
                                                                      ...
                                                                      ,$form_questions->answer_type,array('class' => 'form-control','id' => 'answer_type')) !!}
                               </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                     {!! Form::file('question_file',array('class'=>'btn btn-block btn-grey','id' => 'question_file')) !!}
                                      ...
                                      <?php 
                                      $question_file = $form_questions->question_file;
                                      if (isset($question_file) && ($question_file!="")) { ?>
                                        <a target="_blank" href="<?php echo url('/') . "/resources/views/Form_question/Form_question_files/" . $question_file; ?>">View</a>
                                        <a href="<?php echo url('/') . "/Form_question/Delete_image/". $question_file.'/'.$form_questions->form_questions_id.'/creator_id/'.$id; ?>" onclick="return confirm('Are you sure you want to delete this image?');">|Delete</a>
                                      <?php } ?>
                            ...
                            <div class="form-group" id="question_phrase" >
                                ...
                                <div class="col-md-7">
                                    {!! Form::select('questionphrase', ['select1'               => 'User selects one option only (Radio Check Box)',
                                                                        ...
                                                                        $form_questions->questionphrase,array('class' => 'form-control','id' => 'questionphrase')) !!}
