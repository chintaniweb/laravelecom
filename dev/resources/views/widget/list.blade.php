...
<!--        <h2><a href="#">Dashboard</a></h2>
        <div>
            <ul>
                <li class="dashboard" id="UPDATED_PAGES" >Last 5 Updated Pages</li>
                <li class="dashboard" id="SEO_INFORMATION">SEO Information</li>
                <li class="dashboard" id="RECENTLY_VISITED_PAGES">Recently Visited pages</li>
                <li class="dashboard" id="TOP_VISITED">Top Visited</li>
            </ul>
        </div>-->
...
<div class="pull-left" id="cart-outer">
    ...
    <div class=" ui-widget-content ">
        <ol class="ui-droppable ui-sortable">
            <!--li class="placeholder">Add your widget here</li-->
            @foreach ($data['dashboard_data'] as $dashboard) 
            <li class="dashboard ui-draggable ui-draggable-handle ui-sortable-handle" id="{{ $dashboard->widget_id }}" >
    ...
    <div id="shipping"><br>
        ...
        <div class="ui-widget-content">
            <ol class="ui-droppable ui-sortable">
                ...
                <li class='side ui-draggable ui-draggable-handle ui-sortable-handle' id="{{ 'page_'.$sidebar->id }}">
...
<div>
    <!------------------------------FOOTER WIDGET START--------------------------------------------->
    <div id="foter">
        <h1 class="ui-widget-header" style="font-weight:normal;font-size: 23px;">Footer</h1>
        <div class="ui-widget-content">
            <ol>
                @foreach($data['footer_data'] as $footer) 
                <li class='fot ui-sortable-handle' id="page_{{ $footer->id }}">
