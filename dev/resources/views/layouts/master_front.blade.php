...
<html>
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <div class="search-box">
                                ...
                                {!! Form::open(array('url' => 'search_header','class' => 'form-horizontal','onsubmit'=>'myFunction','method'=>'get')) !!}
                                {!! Form::text('search_for', null, array('class' => 'search-input','id' => 'search_for', 'placeholder'=>'Search')) !!}
                                {!! form::close() !!}
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 footer-box-3">
                            ...
                            <div class="footer-detail-box">
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="<?php echo url('/') . '/Location/Location' ?>">Locations</a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <?php if (Request::segment(1) != "calendar_event") { ?>
