                ...
                <div class="topbar-left">
                    ...
                    <div class="text-center"> 
                        <a href="#" class="logo">
                            ...
                            <?php if ($web == 1) { ?>
                                <img src="<?php echo url('/') . '/resources/assets/images/logo-dashboard.png' ?>" alt="" title="" class="logo-img">
                            <?php } else if ($web == 2) { ?>
                                <img src="<?php echo url('/') . '/resources/assets/images/cte-logo.jpg' ?>" alt="" title="" class="logo-img">
                            <?php } else if ($web == 3) { ?>
                                <img src="<?php echo url('/') . '/resources/assets/images/eta-logo.jpg' ?>" alt="" title="" class="logo-img">
                            <?php } ?>
                        </a> 
                    </div>
                </div>
